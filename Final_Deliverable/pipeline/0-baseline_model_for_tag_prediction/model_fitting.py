...
def main(argv=None):
    ...
    parser.add_option("-n", "--n_features", dest="n_features", type=int,
                      help="dimension of the hashing vectorizer(must equivalent to n_features in training step)")
    ...
    if options.n_features is not None and options.model is not None:
