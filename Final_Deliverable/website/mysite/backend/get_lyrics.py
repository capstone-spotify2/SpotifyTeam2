...
def get_lyrics(song_title, artist):
    ...
    try:
        ...
        up_partition = '<!-- Usage of azlyrics.com content by any third-party lyrics provider is ' + \
        ...
        e = "Sorry, we cannot find this song lyrics according to the given artist and song name. " + \
...
def main(argv=None):
    ...
    usage = "Usage: %prog -s song -a artist (pass -h for more info)"
